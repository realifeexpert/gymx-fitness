...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-red-500 via-red-600 to-red-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-start p-12 text-white">
          <h2 className="text-4xl xl:text-5xl font-bold mb-6">
            ...
            <span className="block text-white/90">Fitness Journey! 💪</span>
          </h2>
          <p className="text-xl text-white/80 mb-8 max-w-md leading-relaxed">
            Continue transforming your life with our AI-powered fitness platform. Your goals are waiting!
          </p>
          <div className="space-y-4 text-white/70">
            ...
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-white/70 rounded-full"></div>
              <span>Smart nutrition planning</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-white/70 rounded-full"></div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#fffafb]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#fffafb] text-gray-500">Or log in with</span>
              </div>
            </div>
